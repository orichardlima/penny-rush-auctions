-- Corrigir o problema do erro "ends_at ambiguous" na função auto-bid-system
-- Primeiro, vamos desativar temporariamente o cron job para evitar erros contínuos
...
-- Reativar o cron job do sistema de auto-bid
